...
public class Main {
    ...
    public static String queryBridgeWords(Map<String, Map<String, Integer>> G, String word1, String word2) {
        ...
        for (String bridgeWord : innerMap.keySet()) {
            ...
            if (G.containsKey(bridgeWord) && G.get(bridgeWord).containsKey(word2)) {
                // 如果是，则将桥接词添加到列表中
     ...
     */
    public static String calcShortestPath(Map<String, Map<String, Integer>> G, String word1, String word2) {
        boolean word1Exists = false;
        boolean word2Exists = false;
        for (Map.Entry<String, Map<String, Integer>> entry : Graph.entrySet()) {
            String wordA = entry.getKey();
